...
class GlobalRankedFeatureSelector(nn.Module):
    ...
    It also computes an entropy penalty over the soft probabilities, which
    can be added to the loss to encourage more decisive (i.e. lower entropy)
    feature selection.
    """
    def __init__(self, input_dim, k, init_temp=5.0, final_temp=0.01):
        ...
        # This will store the entropy penalty computed during the forward pass.
    ...
    def forward(self, x):
        ...
        # You can choose to average or sum; here we take the mean entropy.
        self.entropy_penalty = entropy.mean()
