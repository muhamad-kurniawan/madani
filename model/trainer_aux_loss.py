...
class ModelTrainer:
    ...
    def fit(self, epochs=None, checkin=None, losscurve=False, discard_n=10, load_loss_coef=0.01):
        ...
        for epoch in range(epochs):
            ...
            for i, data in enumerate(self.train_loader):
                ...
                # Forward pass
                output, aux_loss = self.model.forward(src, frac)
                ...
                loss = loss + load_loss_coef * aux_loss
                loss.backward()
                self.optimizer.step()
    ...
    def predict(self, loader):
        ...
        with torch.no_grad():
            for (X, y, formula) in loader:
                ...
                output, aux_loss = self.model(src, frac)
