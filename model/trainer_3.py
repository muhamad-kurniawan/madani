...
class ModelTrainer:
    ...
    def multi_stage_fit(self, stage1_epochs=50, stage2_epochs=100, stage3_epochs=50, checkin=5, losscurve=True, discard_n=10, feature_selection_phase=0.5):
        ...
        for epoch in range(stage1_epochs):
            ...
            dt = time() - ti
            # (Validation check every checkin epochs)
        ...
        # -------- Stage 2: Introduce Feature Selection Gradually --------
        print("Stage 2: Training with gradual introduction of feature selection")
